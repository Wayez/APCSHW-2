...
public class BSTree <T extends Comparable> {
    ...
    public BSTreeNode<T> getNext(BSTreeNode<T> curr){
	if (curr.getRight() == null)
	    return curr;
	return getNext(curr.getRight());
    }
	...
	if (curr.getData().equals(c)){
		...
		BSTreeNode<T> y = getNext(curr.getLeft());
		remove(curr, y.getData());
